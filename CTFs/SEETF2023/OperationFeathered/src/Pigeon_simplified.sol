...
contract Pigeon {
    ...
    uint256 private juniorPromotion = 8e18;
    uint256 private associatePromotion = 12e18;
    ...
    function task(bytes32 codeName, uint256 data) public oneOfUs {
        taskPoints[codeName] += data;
    }
